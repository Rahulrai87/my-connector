...
export class SharePointGraphService {
  ...
  async syncFilesBasedOnLastRun(
    ...
    return this.fetchFilesRecursivelyDrive(
      siteId,
      driveId,
      lastRunAt,
      normalizedExtensions,
  ...
  // =====================================================
  // RECURSIVE DRIVE FETCH (FULL + INCREMENTAL)
  // =====================================================
  private async fetchFilesRecursivelyDrive(
    siteId: string,
    driveId: string,
    ...
    while (stack.length > 0) {
      ...
      const endpoint =
        currentId === "root"
          ...
          : `/sites/${siteId}/drives/${driveId}/items/${currentId}/children`;
